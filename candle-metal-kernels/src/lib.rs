...
pub use kernels::{
    ...
    call_binary_strided_with, call_mlx_gemm, cast::*, convolution::*, fill::*, indexing::*,
    quantized::*, random::*, reduce::*, sdpa::*, sort::*, ternary::*, unary, unary::*, ConvKernel,
    GemmDType, GgmlDType, ReduceKernel,
};
use metal::{
